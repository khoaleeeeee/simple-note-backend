...
var logger = (0, _logger.createLogger)("NoteDeltaAdd");
var add = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(noteDelta) {
    var insertPromises, results;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          (0, _assert["default"])(noteDelta.note_uuid, "note_uuid is required");
          (0, _assert["default"])(noteDelta.deltas, "deltas are required");
          _context.prev = 2;
          insertPromises = noteDelta.deltas.map(function (delta) {
            var queryText = "\n        INSERT INTO note_deltas (note_uuid, delta)\n        VALUES ($1, $2)\n        RETURNING *;\n      ";
            var values = [noteDelta.note_uuid, JSON.stringify(delta)];
