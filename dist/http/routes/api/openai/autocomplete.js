...
var trimmer = function trimmer(promptText, text) {
...
var autocomplete = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, topic, promptText, prompt, openai, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          // throw new Error("This is a test error");
          _req$body = req.body, topic = _req$body.topic, promptText = _req$body.promptText;
          prompt = "Given the topic '".concat(topic, "', complete the text '").concat(promptText, "' in a meaningful way. Return only the additional part. Don't include quotation marks");
